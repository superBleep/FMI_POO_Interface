            ...
            return (
                <Table style={{color: 'white', textAlign: 'center'}}>
                    ...
                    <tbody>
                        {studentProjects.map(
                            project => {
                                if(project.starred) var star = <FontAwesomeIcon icon={faStar} style={{color: "#ffff00",}} />
        ...
        return (
            <div id='studentIndex' className='text-white'>
                <Modal show={show} onHide={handleClose} centered backdrop='static'>
                    ...
                    <Modal.Footer>
                        <Button variant='primary' type='submit' form='addProjectForm' onClick={handleClose}>Adaugă</Button>
                    </Modal.Footer>
                </Modal>
                ...
                <Modal show={show2} centered backdrop='static'>
                    ...
                    <Modal.Footer>
                        <Button variant='danger' onClick={handleClose2}>Nu</Button>
                ...
                <div id='projectsDiv'>
                    ...
                    <Button variant='primary' onClick={handleShow} title='Adaugă un proiect'><FontAwesomeIcon icon={faPlus} /> Proiect</Button>
                    <hr></hr>
                    {showProjects()}
                </div>
            </div>
