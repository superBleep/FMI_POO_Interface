...
export default function initModels(sequelize) {
  ...
  Class.belongsToMany(User, { as: 'user_id_Users', through: User_Class, foreignKey: "class_id", otherKey: "user_id" });
  User.belongsToMany(Class, { as: 'class_id_Classes', through: User_Class, foreignKey: "user_id", otherKey: "class_id" });
